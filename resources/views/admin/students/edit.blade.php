...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('admin.students.update', $student->slug) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="dob" id="dob"
                        ...
                        value="{{ old('dob', $student->student->dob ? $student->student->dob->format('Y-m-d') : '') }}">
                    @error('dob')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="address" id="address"
                        ...
                        value="{{ old('address', $student->student->address ?? '') }}">
                    @error('address')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" name="parent_phone" id="parent_phone"
                        ...
                        value="{{ old('parent_phone', $student->student->parent_phone ?? '') }}">
                    @error('parent_phone')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" name="emergency_contact" id="emergency_contact"
                        ...
                        value="{{ old('emergency_contact', $student->student->emergency_contact ?? '') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="grade_level" id="grade_level"
                        ...
                        value="{{ old('grade_level', $student->student->grade_level ?? '') }}">
                    @error('grade_level')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
